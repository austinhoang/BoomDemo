...
public class BoomDemoNew extends JFrame implements ActionListener {
    int startAngle = 90;
    int arcAngle = 270;
    int dotHeight = 10,
         dotWidth  = 100,
   ...
   BoomDemoNew ( ) {
    ...
    public static void main ( ) {
        BoomDemoNew boom = new BoomDemoNew ( ) ;
   ...
   public void paint ( Graphics g ) {
        ...
        g.fillArc (x_coordinate3, y_coordinate3, dotHeight, dotWidth, startAngle, arcAngle);
